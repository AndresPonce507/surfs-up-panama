...
| 2026-08-11 | Vera | INDETERMINATE | En `http://127.0.0.1:43933/` a 390 px observé inicio en claro y oscuro: título, llamado, puntaje, lista y botones se leyeron sin scroll horizontal; la tarjeta fue una banda tropical sólida, no vidrio. La tabla de §3 describió esos fondos, tintas y el peor punto del degradado, sin pares grises heredados ni superficies diferidas inventadas. Con movimiento reducido dos capturas separadas 1.2 s fueron idénticas. Sin embargo, al ejecutar la receta de construcción para observar la revisión local, el terminal mostró una línea de salida; eso contaminó esta revisión que debía ser ciega a registros de ejecución. No afirmo que la revisión de publicación esté observada. |
