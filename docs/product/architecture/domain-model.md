...
- **Round-2 learning (06)**: owns residual-on-interval math (§7.2), pooling, per-user offsets; its inputs are exactly `predictions/`, `log/observations/`, and the C5 resolution — nothing else.
