...
Feature: El anuncio lleva una tarjeta de verdad, rehecha en cada publicación
  ...
  @slice-04 @driving_port @real-io @adapter-integration @covers-R14
  ...
  @slice-04 @driving_port @real-io @adapter-integration @negative @covers-R15
  ...
  @slice-04 @driving_port @real-io @adapter-integration @error @covers-R16
  ...
  @slice-04 @driving_port @real-io @adapter-integration @covers-R17
