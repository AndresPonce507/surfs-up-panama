...
export type MonthCloseReads = Readonly<{
  ...
  costAllocationTags: Readonly<{ CostAllocationTags?: readonly Readonly<{ TagKey?: string; Type?: string; Status?: string }>[] }>;
...
export declare function evaluateMonthClose(input: Readonly<{ reads: MonthCloseReads }>): Readonly<{ exitCode: number; lines: readonly string[] }>;
